...
const Team = () => {
  return (
    <div className='bg-[#171A23]'>
      <h1 className="text-center text-4xl  md:text-[42px] md:p-8 lg:text-[45px] lg:p-9 xl:text-[50px] p-10 align-middle bg-clip-text font-medium text-transparent bg-gradient-to-r from-[#369fff] to-[#14C58F]">
        Meet The Team
      </h1>
      
      <div className="text-white pl-8 pr-8 sm:pl-11 sm:pr-11 md:pl-20 md:pr-20 lg:pl-24 lg:pr-24 ">
        <h1 className="text-left text-[26px] sm:text-[27px] md:text-[28px] lg:text-[32px] xl:text-[36px] font-semibold bg-clip-text text-transparent bg-gradient-to-r from-[#369FFF] via-[#3BD0A3] to-[#14C58F]">
          Technical Team
        </h1>
        ...
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-7 md:gap-8 lg:gap-9">
            {teamMembers.map((member, index) => (
              <div key={index} className="relative gradient-border pt-6">
