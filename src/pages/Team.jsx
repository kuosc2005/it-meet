  ...
  return (
    <div className='bg-[#171A23]'>  
        ...
        <div className="sm:hidden">
          <button className="w-full px-4 py-2 bg-gray-700 text-gray-300 font-semibold rounded hover:bg-gradient-to-r hover:from-[#369FFF] hover:to-[#14C58F] hover:text-white" onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
