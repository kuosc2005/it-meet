  ...
  return (
    <div className='bg-[#171A23]'>  
        ...
        <div className="text-white pl-8 pr-8 sm:pl-11 sm:pr-11 md:pl-20 md:pr-20 lg:pl-24 lg:pr-24">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-4 mb-8">
              {team.map((team, index) => (
                <button
                key={index}
            ...
            <div ref={membersSectionRef}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-7 md:gap-8 lg:gap-9 mt-8">
                {team[selectedTeamIndex].members.map((member, memberIndex) => (
                  <div key={memberIndex} className="relative gradient-border pt-6">
                    <div className="flex items-left justify mb-1">
                      <svg
                        className="w-[15px] h-[24px] md:w-[20px]"
                        viewBox="0 0 20 24"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <path
                          d="M10 0L20 5.7735V17.3205L10 23.094L0 17.3205L0 5.7735L10 0Z"
                          fill="#05E2BD"
                        />
                        <path
                          d="M7.03927 9.75626C6.86227 8.93736 7.75872 8.30966 8.46769 8.75607L13.6313 12.0073C14.3193 12.4405 14.1763 13.4824 13.397 13.7142L11.5787 14.2551C11.3809 14.3139 11.2077 14.4358 11.0857 14.6022L10.0123 16.0655C9.53007 16.723 8.49748 16.5029 8.32522 15.7059L7.03927 9.75626Z"
                          fill="#171A23"
                        />
                      </svg>
