  ...
  return (
    <div className="bg-[#171A23] pb-6">
      ...
      <div className="text-white pl-8 pr-8 sm:pl-11 sm:pr-11 md:pl-20 md:pr-20 lg:pl-24 lg:pr-24">
        ...
        <div>
          <h1
            className={`text-left text-[26px] mt-4 sm:text-[27px] sm:mt-0 md:text-[28px] lg:text-[32px] xl:text-[36px] font-semibold bg-clip-text text-transparent bg-gradient-to-r from-[#369FFF] via-[#3BD0A3] to-[#14C58F]`}
          >
