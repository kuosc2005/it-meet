...
const Team = () => {
  return (
    <div className='bg-[#171A23]'>
      <h1 className="text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl pt-10 pb-5 lg:pb-0 font-bold align-middle bg-clip-text text-transparent bg-gradient-to-r from-[#369FFF] via-[#3BD0A3] to-[#14C58F]">
        Meet The Team
      </h1>
      
      <div className="text-white p-5 sm:p-5 md:p-11 lg:p-20">
            ...
            {teamMembers.map((member, index) => (
              <div
                ...
                <div className="flex items-left justify mb-4">
                  ...
                  <span className="ml-2 text-sm pt-[3px] sm:pt-0 md:text-lg lg:text-base">{member.department}</span>
                </div>
                ...
                <img src={shadowImage} className="absolute h-[400px] w-auto transform top-5 opacity-60" />
                  ...
                  <img
                    src={member.image}
                    className="h-[300px] sm:h-[350px] lg:h-[400px] w-auto transform filter grayscale group-hover:filter-none object-contain transition duration-300"
                    alt={member.name}
                  />
                </div>
              </div>
