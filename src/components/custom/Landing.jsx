...
export default function LandingComponent() {
	return (
		<div className="relative w-screen h-auto overflow-hidden bg-[#171A23]">

			<div className="relative w-full h-full">
				
				<img src={ku_Lawn} alt="KU Lawn" className=" w-full object-contain"/>
				...
				<div className="absolute top-[8%] sm:top-[5%] md:top-[5%] lg:top-[5%] xl:top-[12%] w-full flex justify-center animate-logo">
				...
				<div className='absolute top-[8%] sm:top-[4%] md:top-[4%] lg:top-[4%] xl:top-[12%] w-full justify-center flex flex-col items-center animate-date'>
