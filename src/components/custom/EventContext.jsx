...
export const EventProvider = ({ children }) => {
  const [mainEvents] = useState([
    ...
    //   description:
    //     "The event showcases participants' coding skills across various difficulty levels, fostering a collaborative community, with 28 participants demonstrating their talent in 2024.",
    //   details:
    //     'The Coding Challenge is a dynamic competition that immerses participants in the world of coding and problem-solving, showcasing their technical prowess and innovation. With challenges spanning Easy, Medium, and Hard levels, participants navigate through complex coding problems individually, pushing the boundaries of their skills and fostering healthy competition. Beyond a mere contest, this event cultivates a community where coding enthusiasts converge to exchange ideas and elevate their abilities. In IT Meet 2024, 28 participants took part, demonstrating exceptional coding skills and contributing to a vibrant atmosphere of skill development and companionship at the IT Meet.',
    // },
    // {
    //   id: 8,
    //   imgSrc: '/line.webp',
    ...
    //   description:
    //     'The event challenges participants to program robots to navigate a course using line-following sensors, with 48 individuals in 12 teams showcasing their skills over two days at IT Meet 2024.',
    //   details:
    //     'In the “Line Following Robot” event, participants will demonstrate their robots’ accuracy and speed as they maneuver through a specified course using advanced line-following methods. These robots, equipped with specialized sensors, will skillfully track a marked path on the floor. Success hinges on precisely programming the robots to process real-time sensor data, enabling them to make smart decisions and navigate the course efficiently in the shortest possible time. In IT Meet 2024, this event spanned two days and saw the participation of around 48 individuals organized into 12 teams, showcasing their technical expertise and competitive spirit.',
    // },
    {
      id: 9,
      imgSrc: '/career.webp',
    ...
    //   details:
    //     "The “Photography Competition” invites participants to showcase their artistic talents by submitting their best photographs for exhibition at the venue. Visitors to the event have the opportunity to vote for their favorite photograph, recognizing the most compelling portrayal of this theme. Last year, in IT Meet 2024, the contest drew participation from 53 photographers, each contributing unique perspectives and interpretations through their images. The winning photographer was awarded a prize, acknowledging their skill in capturing the essence of technology's impact on our lives through the art of photography.",
    // },
    // {
    //   id: 12,
    //   imgSrc: '/quiz.webp',
  ...
  const [preEvents] = useState([
    ...
    //   details:
    //     'The “AR Treasure Hunt” is an exhilarating event that introduces participants to the world of Augmented Reality. Emulating the excitement of games like Pokémon Go, teams embark on an adventure, following clues to uncover hidden treasures. The 2024 AR Treasure Hunt, marking its second edition, seamlessly combined technology and cultural exploration. With 218 attendees, the event featured multiple exciting rounds and culminated in a thrilling finale at Patan Durbar Square.',
    // },
    // {
    //   id: 12,
    //   imgSrc: '/kubing.webp',
