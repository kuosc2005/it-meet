      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:gap-5">
          <div className="w-full sm:w-1/2">
            ...
            />
            {errors.fullName && (
              <p className="text-red-700 text-xs md:text-sm mt-1">{errors.fullName.message}</p>
            )}
          </div>
          ...
          <div className="w-full sm:w-1/2 mt-4 sm:mt-0">
            ...
            />
            {errors.email && (
              <p className="text-red-700 text-xs md:text-sm mt-1">{errors.email.message}</p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          />
          {errors.message && (
            <p className="text-red-700 text-xs md:text-sm mt-1">{errors.message.message}</p>
          )}
        </div>
